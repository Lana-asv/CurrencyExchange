...
protocol SecondScreenCollectionViewCellDelegate: AnyObject {
    func currencyItemCellDidBeginEditing(_ cell: SecondScreenTableViewCell)
    func currencyItemCell(_ cell: SecondScreenTableViewCell, didChange amount: Decimal?)
}

final class SecondScreenTableViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    weak var delegate: SecondScreenCollectionViewCellDelegate?
    ...
    @objc private func editingChanged() {
        var value: Decimal?
        if let string = currencyTextField.text {
